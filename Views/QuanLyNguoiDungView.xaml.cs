...
namespace PlantManagement.Views
{
    public partial class QuanLyNguoiDungView : UserControl
    {
        ...
        public QuanLyNguoiDungView()
        {
            ...
            UserGroupButton.RaiseEvent(new RoutedEventArgs(Button.ClickEvent));
        }
        ...
        private void ExpanderButton_Click(object sender, RoutedEventArgs e)
        {
            if (sender is Button clickedButton)
            {
                ...
                {
                    case "UserGroupButton":
                        var userGroupTable = _userController.GetUserGroupData();
                        UserGroupDataGrid.ItemsSource = null;
                        UserGroupDataGrid.ItemsSource = userGroupTable.DefaultView;
                        UserGroupDataGrid.Visibility = Visibility.Visible;
                        break;
        ...
        {
            // Ẩn tất cả các DataGrid
            UserGroupDataGrid.Visibility = Visibility.Collapsed;
        ...
        public void UserGroup_Click(object sender, RoutedEventArgs e)
        {
            // Ẩn tất cả các DataGrid
            HideAllDataGrids();

            // Đổi màu nền của nút
            ResetButtonBackground(UserGroupButton);

            // Lấy dữ liệu từ controller
            var userGroupTable = _userController.GetUserGroupData();

            // Gán dữ liệu vào DataGrid
            UserGroupDataGrid.ItemsSource = null; // Đảm bảo xóa dữ liệu cũ
            UserGroupDataGrid.ItemsSource = userGroupTable.DefaultView; // Gán dữ liệu mới
            UserGroupDataGrid.Visibility = Visibility.Visible; // Hiển thị DataGrid
        }
        ...
        private void AddNewUserButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true) // Nếu người dùng được thêm thành công
            {
